...
module.exports = (name, haveTest) => {
  // rendering
  console.log(chalk.dim(`🖍   Rendering class component from template`))
  const templatePath = `${__dirname}/../../templates/ClassComponent.js.ejs`;
  ...
  if (haveTest) {
    ...
    const testTemplatePath = `${__dirname}/../../templates/ClassComponent.test.js.ejs`;
  ...
  // done
  console.log(ui.c.p(`\n🏁  Finished generation ${name} class component!`))
}
